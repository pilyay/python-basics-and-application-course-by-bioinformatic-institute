# Курс Python: основы и применение [:top:](https://github.com/pilyay?tab=repositories)
...
* :books: **Содержание**
	* :closed_book: [Задачи](https://github.com/pilyay/python-basics-and-application-course-by-bioinformatic-institute/blob/main/tasks/phyton_basics_and_application.ipynb)
